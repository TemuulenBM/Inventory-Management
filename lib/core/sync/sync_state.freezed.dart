...
class _$SyncStateImpl implements _SyncState {
  ...
  @override
  String toString() {
    return 'SyncState(status: $status, isOnline: $isOnline, pendingCount: $pendingCount, lastSyncTime: $lastSyncTime, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, status, isOnline, pendingCount, lastSyncTime, errorMessage);
...
abstract class _SyncState implements SyncState {
  const factory _SyncState(
      ...
      final DateTime? lastSyncTime,
      final String? errorMessage}) = _$SyncStateImpl;
